                    ...
                    <Droppable droppableId="course">
                        {(provided)=> (
                            <div ref={provided.innerRef} {...provided.droppableProps}>
                                ...
                                {courseData && courseData.map(({id, title, price, type, picture}, index)=> (
                                    ...
                                    <div 
                                        ...
                                        // key={course.id}
                                        className="bg-[#F7F7F7] shadow-[10px_10px_60px_-15px_rgba(0,0,0,0.3)] border border-blue-200  my-3 flex flex-row justify-between w-5/6 h-16 px-3 items-center rounded-md">
